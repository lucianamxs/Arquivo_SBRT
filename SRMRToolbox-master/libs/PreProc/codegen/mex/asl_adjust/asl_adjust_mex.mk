START_DIR = /home/rafael/Documentos/MATLAB/SRMRToolbox-master/libs/PreProc

MATLAB_ROOT = /usr/local/MATLAB/R2013a
MAKEFILE = asl_adjust_mex.mk

include asl_adjust_mex.mki
...
MEX_FILE_NAME_WO_EXT = asl_adjust_mex
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/asl_adjust"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/asl_adjust/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/asl_adjust/%.cu
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/asl_adjust/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
