START_DIR = /home/rafael/Documentos/MATLAB/SRMRToolbox-master/libs/vad

MATLAB_ROOT = /usr/local/MATLAB/R2013a
MAKEFILE = vad_s_mex.mk

include vad_s_mex.mki
...
MEX_FILE_NAME_WO_EXT = vad_s_mex
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/vad_s"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/vad_s/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/vad_s/%.cu
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/vad_s/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
